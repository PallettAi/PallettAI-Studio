...
ok(/node_modules\/grapesjs\/dist\/grapes\.min\.js/.test(html), 'GrapesJS loads from the local package');
ok(/node_modules\/vvvebjs\/libs\/builder\/builder\.js/.test(html), 'VvvebJS loads from the local package');
ok(/components-common\.js/.test(html) && /components-html\.js/.test(html), 'VvvebJS component catalog modules load locally');
