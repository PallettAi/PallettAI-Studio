...
const aFresh = AI.generateSite(PROMPT, { brief: BRIEF_A, onePager: true, salt: 1 });
assert(a1 && a1.site && a1.site.fingerprint && typeof a1.site.fingerprint.seed === 'number', 'site stores a fingerprint seed');
assert(dnaOf(a1) === dnaOf(a2), 'same brief without a salt remains reproducible');
assert(dnaOf(a1) !== dnaOf(aFresh), 'a fresh generation salt changes the design DNA');
